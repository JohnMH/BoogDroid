...
import me.albfan.boogdroid.bugzilla.ChangeStatusInfo;
import me.albfan.boogdroid.ui.AdapterProduct;
...
public abstract class Server {
    ...
    private me.albfan.boogdroid.db.Server databaseServer = null;
    ...
    public void save() {
        if (databaseServer == null) {
            databaseServer = new me.albfan.boogdroid.db.Server();
        }
